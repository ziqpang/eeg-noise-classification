...
np.save('/root/autodl-tmp/DeepSeparator-main/data/train_input.npy', train_input)
np.save('/root/autodl-tmp/DeepSeparator-main/data/train_output.npy', train_output)
np.save('/root/autodl-tmp/DeepSeparator-main/data/test_input.npy', test_input)
np.save('/root/autodl-tmp/DeepSeparator-main/data/test_output.npy', test_output)

np.save('/root/autodl-tmp/DeepSeparator-main/data/EOG_EEG_test_input.npy', EOGEEG_test_input)
np.save('/root/autodl-tmp/DeepSeparator-main/data/EOG_EEG_test_output.npy', EOGEEG_test_output)
np.save('/root/autodl-tmp/DeepSeparator-main/data/EMG_EEG_test_input.npy', EMGEEG_test_input)
np.save('/root/autodl-tmp/DeepSeparator-main/data/EMG_EEG_test_output.npy', EMGEEG_test_output)
